...
public class CalculoValorLocacaoTeste {
	...
	private LocacaoService servicoLocacao;
	...
	@Before
	public void setUp() {
		servicoLocacao = new LocacaoService();;
		
		dao = Mockito.mock(LocacaoDAO.class);
		servicoLocacao.setLocacaoDAO(dao);
		
		spcService = Mockito.mock(SPCService.class);
		servicoLocacao.setSpcService(spcService);
	}
	...
	public void deveCalcularValorLocacaoConsiderandoDescontos() throws FilmeSemEstoqueException, LocadoraException {
		...
		//WHEN/ QUANDO
		Locacao resultado = servicoLocacao.alugarFilme(caraQueAlugou, listaDeFilmes);
